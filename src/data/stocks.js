...
export const WEEKS = [
  {
    ...
    note: 'Index anchor + highest conviction AI names',
    days: [
      { day: 'MON', stocks: ['VOO', 'NVDA'],  note: 'Largest positions — anchor the week' },
      { day: 'TUE', stocks: ['MSFT', 'META'],  note: 'AI Core duo — Azure + ad machine' },
      { day: 'WED', stocks: ['VOO', 'CRWD'],   note: 'Index top-up + cybersecurity' },
      { day: 'THU', stocks: ['NVDA', 'APLD'],  note: 'AI infrastructure double-down' },
      { day: 'FRI', stocks: ['VOO', 'AXON'],   note: 'Index + govt safety diversifier' },
    ],
  },
  {
    week: 2, theme: 'Growth & Safety Week',
    note: 'Healthcare, public safety, rare earth — non-AI diversification',
    days: [
      { day: 'MON', stocks: ['VOO', 'CRWD'],   note: 'Index + security — non-discretionary' },
      { day: 'TUE', stocks: ['AXON', 'NFLX'],  note: 'Govt + streaming — both uncorrelated to AI selloffs' },
      { day: 'WED', stocks: ['VOO', 'MSFT'],   note: 'Index + most durable AI name' },
      { day: 'THU', stocks: ['TSLA', 'MP'],    note: 'Autonomy bet + rare earth play' },
      { day: 'FRI', stocks: ['VOO', 'META'],   note: 'Index + ad monopoly close out' },
    ],
  },
  {
    week: 3, theme: 'AI Infra Week',
    note: 'Highest upside names — NVDA and APLD heavy',
    days: [
      { day: 'MON', stocks: ['VOO', 'NVDA'],   note: 'Anchor repeat — NVDA every cycle' },
      { day: 'TUE', stocks: ['APLD', 'CRWD'],  note: 'Infra + security — both non-index' },
      { day: 'WED', stocks: ['VOO', 'AXON'],   note: 'Index + public safety' },
      { day: 'THU', stocks: ['MSFT', 'NFLX'],  note: 'Quality compounders — durable cash generators' },
      { day: 'FRI', stocks: ['VOO', 'META'],   note: 'Index + meta to close' },
    ],
  },
  {
    week: 4, theme: 'Rebalance Week',
    note: 'Even distribution — check drift and trim if needed',
    days: [
      { day: 'MON', stocks: ['VOO', 'NVDA'],   note: 'Consistent anchor — never skip NVDA' },
      { day: 'TUE', stocks: ['TSLA', 'MP'],    note: 'Smaller positions — autonomy + rare earth' },
      { day: 'WED', stocks: ['VOO', 'CRWD'],   note: 'Index + security anchor' },
      { day: 'THU', stocks: ['NFLX', 'AXON'],  note: 'Streaming + govt — non-AI diversifiers' },
